...
handoff: docs/plans/2026-04-24-phase-d-slices-5-7-handoff.md
gate_override: auto
gate_override_reason: "styles/ dir is <60 days old (introduced 2026-04-24 in Slice 3); Slice 4 had same override for same reason; Slice 5 appends same file"
files:
  - styles/shared.css (append)
  - research/market-clusters.html (new)
  - research/ten-year-picture.html (new)
  - research/seo-and-discovery.html (new)
  - research/growth-opportunities.html (new)
---
...
Phase D of the reshape. Slices 2–4 shipped in the previous session: Slice 2 locked 12 decisions including the research-page wireframe (D11) + dossier aesthetic (D12); Slice 3 extracted inline CSS to `styles/shared.css`; Slice 4 rewrote `index.html` per wireframe A and committed `research/*.html` hrefs at [index.html:237-240](index.html:237).
...
**Reader persona (Slice 2 D5, unchanged here):** Main page already uses "Jay Z" throughout as reader name ([index.html:9,27,30](index.html:9)). Slice 5 pages continue the persona for voice consistency. The privacy clarification does NOT revoke the Jay-Z persona — persona is a voice choice (Slice 2 D5 decision); privacy is a PII-leak bar. They're orthogonal.

**Policy coherence flag (out of Slice 5 scope):** [README.md:5-7](README.md:5) currently states "The real name, real URLs, and real referral codes never land here." That line is stricter than the 2026-04-24 clarification (real name OK; URLs / referral codes still excluded). Resolution rule: **when two policy sources disagree, the later-timestamp statement wins** — the in-chat clarification (2026-04-24) is the authoritative policy. README wording should be softened in a follow-up pass (Slice 6 candidate — see Follow-ups §1 below). Slice 5 does not edit README.

Slice 6 (proofread) and Slice 7 (ship) are separate, deferred to later sessions.

## Verified Assumptions

| Claim | Source | Status | Verified At | Verify | Evidence |
|-------|--------|--------|-------------|--------|----------|
| index.html §6 has 4 research-page hrefs | [`index.html:237-240`](index.html:237) | VERIFIED | 2026-04-24T05:50:00-0500 | rg -n 'href="research/' index.html |
| index.html §1 names 5 peers: Ceranna, Avvagraphy, 2 Brides, Honest Guide, Paul Zizka | [`index.html:34`](index.html:34) | VERIFIED | 2026-04-24T05:50:00-0500 | rg -n 'Ceranna, Avvagraphy, 2 Brides, Honest Guide, Paul Zizka' index.html |
| §4.1 has 1-paragraph sketch per peer (the "full map") | [`index.html:180-184`](index.html:180) | VERIFIED | 2026-04-24T05:50:00-0500 | rg -q 'Ceranna Photography' index.html |
| shared.css is 1617 lines, ends at line 1616 (closing media query) | [`styles/shared.css:1616`](styles/shared.css:1616) | VERIFIED | 2026-04-24T05:50:00-0500 | wc -l styles/shared.css |
| .research-block already exists (from pre-reshape) | [`styles/shared.css:1246`](styles/shared.css:1246) | VERIFIED | 2026-04-24T05:50:00-0500 | rg -q 'research-block' styles/shared.css |
| .observed / .inferred / .may-mean / .experiment do NOT yet exist | n/a | VERIFIED | 2026-04-24T05:50:00-0500 | ! rg -q '^\.(observed\|inferred\|may-mean\|experiment)\\b' styles/shared.css |
| research/ directory does not exist yet | n/a | VERIFIED | 2026-04-24T05:50:00-0500 | ! test -d research |
| Fonts loaded via `<link>` in index.html head (Fraunces + Inter) | [`index.html:12`](index.html:12) | VERIFIED | 2026-04-24T05:50:00-0500 | rg -n 'fonts.googleapis.com' index.html |
| shared.css uses var(--serif) / var(--sans) | [`styles/shared.css:17-18`](styles/shared.css:17) | VERIFIED | 2026-04-24T05:50:00-0500 | rg -nw -- '--serif' styles/shared.css |
| 5 peers all have public evidence (site, published content) | [`../docs/plans/archive/2026-04-20-discovery-plan.md:54-73`](../docs/plans/archive/2026-04-20-discovery-plan.md:54), [`docs/research/2026-04-21-round-2-research/trust-family-business-models.md:71-89`](docs/research/2026-04-21-round-2-research/trust-family-business-models.md:71) | VERIFIED | 2026-04-24T05:50:00-0500 | test -s ../docs/plans/archive/2026-04-20-discovery-plan.md && test -s docs/research/2026-04-21-round-2-research/trust-family-business-models.md |
| 8 SEO recipes content lives in UMBRELLA discovery-plan.md:290-345 (not submodule) | | VERIFIED | 2026-04-24T05:50:00-0500 | | Read confirmed 2026-04-24 via sed -n '290,345p' /Users/profile_1/Coding/jarda/docs/plans/archive/2026-04-20-discovery-plan.md — file outside submodule scope (umbrella-relative path rejected by preflight CWD); content grep for "AEO intro rewriter" returns 2 matches (lines 331, 422). |
| 4-archetype + Paul Zizka + 10-year-horizon content | [`docs/research/2026-04-21-round-2-research/trust-family-business-models.md:21-150`](docs/research/2026-04-21-round-2-research/trust-family-business-models.md:21) | VERIFIED | 2026-04-24T05:50:00-0500 | wc -l docs/research/2026-04-21-round-2-research/trust-family-business-models.md |
| Growth gaps + 4-stack revenue template | [`../docs/plans/archive/2026-04-20-discovery-plan.md:77-99`](../docs/plans/archive/2026-04-20-discovery-plan.md:77), [`docs/research/2026-04-21-round-2-research/trust-family-business-models.md:134-214`](docs/research/2026-04-21-round-2-research/trust-family-business-models.md:134) | VERIFIED | 2026-04-24T05:50:00-0500 | rg -q 'Growth gaps' ../docs/plans/archive/2026-04-20-discovery-plan.md |
| Main page uses "Jay Z" reader persona (Slice 2 D5) | [`index.html:9,27,30`](index.html:9) | VERIFIED | 2026-04-24T05:50:00-0500 | rg -c 'Jay Z' index.html |
| D11 wireframe B + D12 dossier aesthetic locked | [`docs/plans/prds/2026-04-24-reshape/slice-2-blueprint.md:201,356`](docs/plans/prds/2026-04-24-reshape/slice-2-blueprint.md:201) | VERIFIED (with Slice 5 additive extensions — see note below) | 2026-04-24T05:50:00-0500 | rg -q 'D11 ' docs/plans/prds/2026-04-24-reshape/slice-2-blueprint.md |
...
**Demo:** `rg -n 'Slice 5: dossier aesthetic' styles/shared.css` returns a match. All dossier rules are scoped under `body.research-dossier` (no bare `.observed` / `.inferred` / etc.). `wc -l` increases from 1617 to ~1720. No existing selectors edited.

**Files:** `styles/shared.css`
...
3. Scoped layout: `body.research-dossier main { max-width: 720px; margin: 0 auto; padding: 48px 24px; }` — mirrors Slice 4's content-flow sizing at [shared.css:1447](styles/shared.css:1447).
...
**Tests:**
- All scoped selectors present: `rg -oc 'body\.research-dossier' styles/shared.css` ≥ 13 (count of matches via `-o`, not matching lines).
- No bare evidence selectors introduced: `! rg -n '^\.(observed|inferred|may-mean|experiment)\s*\{' styles/shared.css` (match = fail — they must be scoped).
- Section comment present: `rg -q '=== Slice 5: dossier' styles/shared.css`.
- PII scan: `! rg -ni '(@[a-z0-9][a-z0-9.-]*\.[a-z]{2,}|\+\d{2,3}[ -]?\d{3,}|I[ČC]O[ :]*\d{5,}|\bs\.r\.o\.|\ba\.s\.\b|\bspol\. s r\.o\.|\bLLC\b|\bLtd\b|\bInc\b)' styles/shared.css`
...
**Files:** `research/market-clusters.html` (new).

**Content grounding (per peer — `.observed` is public-only):**
- **Ceranna Photography** — observed: Italy+CZ dual-market positioning, adventure-elopement site-wide frame, portfolio indexed by story ([docs/plans/archive/2026-04-20-discovery-plan.md:59](docs/plans/archive/2026-04-20-discovery-plan.md:59), [index.html:180](index.html:180)). inferred: dual-language workflow likely systematized; bilingual SEO deliberate. may-mean: same lane is available for a record-+-summit frame rather than adventure-elopement. experiment: bilingual landing page test — one post in both CZ and EN, same week, see indexation spread.
...
- **Paul Zizka** — observed: Banff, 15-year career from one place, 8 books, 23K-member community, commercial + workshops + prints + books stack ([trust-family-business-models.md:82-89](docs/research/2026-04-21-round-2-research/trust-family-business-models.md:82)). inferred: compounding shape works; timeline is long. may-mean: 45 European peaks is the same "one place" structural bet. experiment: identify one peak that could anchor a 5-year micro-archive (book + shoots + prints + guide partnership).

**Steps:**
1. Write D11 wireframe B skeleton at `research/market-clusters.html`.
2. Head block: `<meta charset="utf-8">`, viewport, `<meta name="robots" content="noindex, nofollow">` (mirrors [index.html:8](index.html:8)), `<title>Market &amp; peer-cluster map — research notes</title>`, 2 preconnect `<link>` tags to `fonts.googleapis.com` + `fonts.gstatic.com` (copy from [index.html:10-11](index.html:10)), Google Fonts stylesheet `<link>` (copy from [index.html:12](index.html:12)), shared.css `<link href="../styles/shared.css">`.
...
**Tests:**
- `test -s research/market-clusters.html`
- Peer article count is exactly 5: `[ "$(rg -oc 'class="research-block"' research/market-clusters.html)" = "5" ] || echo "peer count wrong"`. (Use `-o` + `-c` so multiple classes on one line count correctly.)
- Evidence-block count is exactly 20: `[ "$(rg -o 'class="(observed|inferred|may-mean|experiment)"' research/market-clusters.html | wc -l)" = "20" ] || echo "evidence block count wrong"`.
- `rg -q 'name="robots"\s+content="noindex' research/market-clusters.html` (noindex required).
- `rg -q 'class="research-sources"' research/market-clusters.html` (citation footer present).
- PII scan: `! rg -ni '(@[a-z0-9][a-z0-9.-]*\.[a-z]{2,}|\+\d{2,3}[ -]?\d{3,}|I[ČC]O[ :]*\d{5,}|\bs\.r\.o\.|\ba\.s\.\b|\bspol\. s r\.o\.|\bLLC\b|\bLtd\b|\bInc\b)' research/market-clusters.html` (expect 0 matches; if citation URLs include `.com` domains, those won't trigger the `@` email pattern).
- `! rg -n '\b(opinionated|convention|as we say|turns out|the truth is|in our view)\b' research/market-clusters.html`
- `rg -q 'href="../styles/shared.css"' research/market-clusters.html`
- `rg -q 'href="../index.html"' research/market-clusters.html`
- `rg -q 'class="research-dossier"' research/market-clusters.html`
- No WhatsApp solicitation: `! rg -qi 'whatsapp\|ping me\|reach out\|dm me\|message me' research/market-clusters.html`
- Word count: `wc -w research/market-clusters.html` → 1200–1700 range (body 1000–1400w prose + HTML tag overhead ~15-20%).
...
**Files:** `research/ten-year-picture.html` (new).
...
- `<section class="observed">` — what's observed in the archetypes:
  - 4 archetypes: Independent Reviewer, Industrial Testing, Membership, Career-Arc Photographer ([trust-family-business-models.md:21-90](docs/research/2026-04-21-round-2-research/trust-family-business-models.md:21)).
  - Paul Zizka template: 8 books, 23K community, one specific place, family-first geography, 15 years ([trust-family-business-models.md:82-89](docs/research/2026-04-21-round-2-research/trust-family-business-models.md:82)).
  - 6 compounding patterns ([trust-family-business-models.md:96-130](docs/research/2026-04-21-round-2-research/trust-family-business-models.md:96)).
...
- `rg -q 'name="robots"\s+content="noindex' research/ten-year-picture.html`
- `rg -q 'class="research-sources"' research/ten-year-picture.html`
- `wc -w research/ten-year-picture.html` → 700–1000 range (~600w body + tags).
...
**Files:** `research/seo-and-discovery.html` (new).
...
**Tests:** same grep suite as 5.2 (adapt filenames), plus:
- `rg -q 'name="robots"\s+content="noindex' research/seo-and-discovery.html`
- `rg -q 'class="research-sources"' research/seo-and-discovery.html`
- `rg -oc 'AEO|Answer Engine' research/seo-and-discovery.html` ≥ 2.
- `rg -oc 'nightwatch.io|frase.io|searchengineland.com|annabauman.com|seoprofy.com' research/seo-and-discovery.html` ≥ 3 (source citations).
- `wc -w research/seo-and-discovery.html` → 850–1100 range (~700–900w body + tags + source URLs).
...
**Files:** `research/growth-opportunities.html` (new).

**Framing note (per Codex R1 — Ceranna evidence is thin for a full-page frame):** Use a 3-section structure, each `<article class="research-block">` with its own evidence anchor and full 4-tier Observed→Inferred→May-mean→Experiment treatment. Ceranna anchors section 1 only. §6 pointer label at [index.html:240](index.html:240) reads "Ceranna-shaped segment moves" — this page delivers on that promise by showing where Ceranna IS the right anchor (lane focus) and naming the other anchors (Zizka, loudavymkrokem) where different evidence is sturdier. Pointer label stays untouched (no Slice 4 edit).

**Content grounding (per [docs/plans/archive/2026-04-20-discovery-plan.md:77-99](docs/plans/archive/2026-04-20-discovery-plan.md:77) growth gaps + [trust-family-business-models.md:134-214](docs/research/2026-04-21-round-2-research/trust-family-business-models.md:134)):**
...
- `.observed`: 4-stack revenue template ([trust-family-business-models.md:204-214](docs/research/2026-04-21-round-2-research/trust-family-business-models.md:204)). CZ-market validation: loudavymkrokem.cz 5-stream, 120-150K CZK/mo ad revenue ([trust-family-business-models.md:216-221](docs/research/2026-04-21-round-2-research/trust-family-business-models.md:216)). Zizka's Banff version: 8 books + commercial + workshops + prints + 23K-member community ([trust-family-business-models.md:82-89](docs/research/2026-04-21-round-2-research/trust-family-business-models.md:82)). 10 revenue channels catalogued with effort/ceiling ([trust-family-business-models.md:134-150](docs/research/2026-04-21-round-2-research/trust-family-business-models.md:134)).
...
**Tests:** same grep suite as 5.2 (adapt filenames), plus:
- `rg -q 'name="robots"\s+content="noindex' research/growth-opportunities.html`
- `rg -q 'class="research-sources"' research/growth-opportunities.html`
- `[ "$(rg -oc 'class="research-block"' research/growth-opportunities.html)" = "3" ] || echo "section count wrong"`.
- `[ "$(rg -o 'class="(observed|inferred|may-mean|experiment)"' research/growth-opportunities.html | wc -l)" = "12" ] || echo "evidence block count wrong (expect 12 = 3×4)"`.
- `wc -w research/growth-opportunities.html` → 800–1100 range (~600–700w body + tags).
...
- **Section comment pattern for shared.css** — follow Slice 4's pattern at [shared.css:1440-1445](styles/shared.css:1440): `/* === Slice N: descriptive-name === */` with a blank line before and after.
- **Google Fonts `<link>`** — copy verbatim from [index.html:12](index.html:12). Every research page head includes it before the shared.css link.
- **Peer-sketch voice pattern** — match tone from [index.html:180-184](index.html:180) (current §4.1). 3-5 sentences per peer, factual + one inference marker ("the pattern is", "the shape is").
...
- **Research-page footer convention** — main page uses a WhatsApp ping-me closer at [index.html:247](index.html:247), appropriate because it's a personal letter. Research pages are public documents anyone can land on; the footer should NOT solicit contact. Keep only `.research-sources` inside `.research-footer`.
- **`../` prefix** — research pages are one directory deep; all asset links use `../` prefix.

## What This Replaces

Nothing. Pre-reshape site had no `/research/` directory. Slice 4 added dead hrefs at [index.html:237-240](index.html:237) pointing forward to this slice. After Slice 5, those hrefs resolve.
...
1. **README.md privacy-policy wording refresh** — [README.md:5-7](README.md:5) says "real name, real URLs, and real referral codes never land here." The 2026-04-24 policy clarification is narrower: real URLs + referral codes still excluded; first name "Jarda" is fine. Soften the README line to reflect that (candidate: Slice 6 or a tiny standalone S-slice). No Slice 5 action.

2. **§6 pointer label refinement (optional)** — [index.html:240](index.html:240) says "Growth opportunities — Ceranna-shaped segment moves". Slice 5.5 delivers Ceranna as one of three anchors (not the sole frame). If that reads as a broken promise, the pointer could be softened to "Growth opportunities — lane focus, revenue mix, reader-specific moves". Candidate: Slice 6 polish pass. Not Slice 5 scope.
